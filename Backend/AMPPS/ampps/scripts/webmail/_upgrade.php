...
global $__settings, $globals, $notes;
	...
	@srm($__settings['softpath'].'/data/cache');
	
	//CHMOD some files
	@schmod($__settings['softpath'].'/data/', $globals['odc'], 1);

	$notes = 'Please visit the above URL and click on <b>Update tables</b> button to upgrade your database.<br /> Once logged in press Ctrl+F5 or Ctrl+R to update web browser cache to avoid JavaScript errors And then you can delete the install folder.';
}

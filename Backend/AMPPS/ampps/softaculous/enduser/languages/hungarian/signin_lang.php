...
$l['user_data_missing'] = 'Az API KULCS vagy API JELSZÓ menő üres';
...
$l['no_username'] = 'Felhasználó név mező üres';
$l['no_password'] = 'Jelszó mező üres';

$l['<title>'] = 'Bejelentkezés';
$l['sign_in'] = 'Bejelentkezés';
$l['log_user'] = 'API KULCS';
$l['log_pass'] = 'API JELSZÓ';

...
$l['r_backup_exp'] = 'If specified, the process will import data from this file.<br/>The file should be stored locally inside <b>/home/webuzo-username/import</b> directory';
...
$l['r_backup'] = 'cPanel backup file (Optional)';

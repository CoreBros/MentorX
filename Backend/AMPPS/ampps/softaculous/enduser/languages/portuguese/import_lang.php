...
$l['please_note'] = '<b>NOTA</b>: O '.APP.' é apenas um script de instalação automática não dando suporte as aplicações instaladas pelo mesmo. Para informações especificas relativamente ao software instalado deverá consultar o endereço do mesmo para mais informações!';

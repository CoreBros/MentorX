...
if(!defined('SOFTADMIN')){
	$theme['url'] = $softpanel->theme['url'].'/default'; // Should point to default
	$theme['this_url'] = $softpanel->theme['url'].'/simple';
}else{
	$theme['url'] = $softpanel->theme['admin_url'].'/default';
	$theme['this_url'] = $softpanel->theme['admin_url'].'/simple';
}
...
$theme['this_images'] = $theme['this_url'].'/images/';//Has a Trailing slash

// Name of this theme
$theme['this_theme'] = 'simple';

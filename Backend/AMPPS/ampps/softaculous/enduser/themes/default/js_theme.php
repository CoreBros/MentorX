			...
			<div class="col-sm-6">
				...
				<div class="row">
					...
					<div class="col-sm-5 col-md-5 col-xs-5">
						...
						<span class="sai_exp2">'.(!empty($globals['off_available_space']) ? '' : $l['available_space'].' : '.(is_numeric($softpanel->spaceremain) ? number_format($softpanel->spaceremain/1024/1024, 2) : $softpanel->spaceremain).' '.$l['mb'].'<br />').'
	...
	if(!empty($installations[$soft])){
		...
		<div class="bg2">
			...
			<tr>
				...
				<th>'.$l['ins_time'].'</th>
				<th>'.$l['version'].'</th>
				<th width="50" colspan="4" style="text-align:center;">'.$l['options'].'</th>
		...
		foreach($installations[$soft] as $ik => $iv){
			...
			$info['overview'] .= '<tr id="trid' . $ik . '">
				...
				<td>'.
				(!empty($is_cloneable) ? '<a href="'.$globals['ind'].'act=sclone&insid='.$ik.'" title="'.$l['clone'].'" class="someclass"><img src="'.$theme['images'].'clone.gif" style="min-width: 20px;" /></a>&nbsp;' : '').
				(empty($globals['disable_backup_restore']) ? '<td width="25" title="'.$l['backup'].'" class="someclass"><a href="'.$globals['ind'].'act=backup&insid='.$ik.'"><img src="'.$theme['images'].'backup.gif" style="min-width: 20px;" /></td></a>' : '').'
				&nbsp;<td width="25" title="'.$l['editdetail'].'" class="someclass"><a href="'.$globals['ind'].'act=editdetail&insid='.$ik.'"><img src="'.$theme['images'].'editdetail.gif" style="min-width: 20px;" /></td></a>
				&nbsp;<td width="25" title="'.$l['remove'].'" class="someclass"><a href="'.$globals['ind'].'act=remove&insid='.$ik.'" title="'.$l['remove'].'" class="someclass"><img src="'.$theme['images'].'remove.gif" style="min-width: 20px;" /></a></td>
				<td>

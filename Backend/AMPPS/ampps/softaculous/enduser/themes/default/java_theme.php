...
if(empty($globals['lictype']) && !empty($scripts[$soft]['force_scripts'])){
	$info['install'] .= '<center class="sai_notice">'.lang_vars($l['not_in_free'], array($software['name'])).(!webuzo() ? '&nbsp;&nbsp;'.$l['notify_admin'] : '').'</center><br />';
}
...
<div class="col-sm-5">
	<label class="sai_head">'.$l['datadir'].'</label><br />
...
<div class="row">
	<div class="col-sm-5">
		<label class="sai_head">'.$l['database_name'].'</label><br />
		<span class="sai_exp">'.$l['database_name_exp'].'</span>
	</div>
	<div class="col-sm-7">
		<input type="text" name="softdb" id="softdb" class="form-control" value="'.POSTval('softdb', $dbdetails['dbname']).'" onblur="checkdbname(\'softdb\', false)" autocomplete="false" /><br />
...
<div class="bg">
	<div class="row">
		<div class="col-sm-12">
			<div id="advoptions_toggle" onclick="toggle_advoptions(\'advoptions\');" class="sai_sub_head" style="cursor:pointer;" ><img id="advoptions_toggle_plus" src="'.$theme['images'].'plus_new.gif" />&nbsp;&nbsp;'.$l['adv_option'].'</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
...
function loadScreenshots(){
	$_('screenshots_iframe').src = '<?php echo fastestmirror().'/screenshots1.php?sid='.$soft;?>';
};

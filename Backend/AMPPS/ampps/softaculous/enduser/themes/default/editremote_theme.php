...
function editremote_theme(){

global $theme, $globals, $user, $l, $error, $panels, $done, $rsite;
...
addonload("checkradio(\''.POSTval('panel', $rsite['panel']).'\');");
...
echo '</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="domain_name" id="domain_name" size="30" value="'.POSTval('domain_name', $rsite['domain_name']).'" />
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="username" id="username" size="30" value="'.POSTval('username', $rsite['username']).'" />
		</td>
	</tr>
...
<br /><br />
<p align="center">
<input type="submit" name="editremotesite" id="editremotesite" value="'.$l['submit'].'" class="sai_graybluebut" />
</p>
</form>';

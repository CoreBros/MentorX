				...
				<form accept-charset="'.$globals['charset'].'" name="clonesoftware" method="post" action="" onsubmit="return checkform();" id="clonesoftware">
					...
					<div class="bg"><br />						
						<div class="row sai_main_head" style="width:100%;" align="center">
							...
							<div class="col-sm-6 col-xs-7" style="padding-top:10px; padding-left:0; text-align:left;">'.$l['prog_staging'].$software['name'].'</div>
						</div><hr>';
					...
					echo'<br /><p align="center">
							...
							<input type="submit" name="softsubmitbut" class="flat-butt" id="softsubmitbut" value="'.$l['create_staging'].'" /><span id="show_txt" style="display:none;"></span>
						</p><br /><br />

...
global $globals, $l, $theme, $langs, $error, $sets, $sites, $user, $themes_count, $plugins_count, $selected_set;
...
$( document ).ready(function() {
	...
	$("#remove_sets").click(function(){
		...
		$.ajax({
			url: window.location+"&ajcall=1&jsnohf=1&sets="+encodeURIComponent(sets_data)+"&remove_sets=1",
			type: "POST",
		...
		<div class="modal-dialog">
		  <div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="text" name="search_input_wp" class="form-control" id="search_input_wp" size="30" placeholder="'.$l['search'].'"/><br />

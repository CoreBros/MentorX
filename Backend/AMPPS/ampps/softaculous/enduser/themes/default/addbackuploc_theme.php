		...
		<div class="row"><br />
			...
			<div class="col-sm-7">
				<select name="protocol" class="form-control" id="protocol">
					<option value="ftp" '.(isset($_REQUEST['protocol']) && $_REQUEST['protocol'] == 'ftp' ? 'selected="selected"' : '').'>'.$l['ftp'].'</option>
					<option value="softftpes" '.(isset($_REQUEST['protocol']) && $_REQUEST['protocol'] == 'softftpes' ? 'selected="selected"' : '').'>'.$l['ftps'].'</option>
					<option value="softsftp" '.(isset($_REQUEST['protocol']) && $_REQUEST['protocol'] == 'softsftp' ? 'selected="selected"' : '').'>'.$l['sftp'].'</option>
					<option value="dropbox" '.(isset($_REQUEST['protocol']) && $_REQUEST['protocol'] == 'dropbox' ? 'selected="selected"' : '').'>'.$l['dropbox'].'</option>
					<option value="gdrive" '.(isset($_REQUEST['protocol']) && $_REQUEST['protocol'] == 'gdrive' ? 'selected="selected"' : '').'>'.$l['gdrive'].'</option>
				</select>
			</div>
		</div>
